...
- Create Angular project with ng: `ng new 23-03-2025-task.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`23-03-2025-task.client.esproj`).
