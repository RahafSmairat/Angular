...
- Create Angular project with ng: `ng new additionaltask.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`additionaltask.client.esproj`).
